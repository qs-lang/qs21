...
/**
 * WARN: Can be replaced by: "{chr: {asc> STR> IDX}}"
 *       there is no need for special purpose funct
 */
// void __qs_lib_cc (qs_t * self)
// {
//   qs_strb_catc(self->rets, 
//     qs_vmem_cstr(self, "cc-0")[qs_vmem_int(self, "cc-1")]
//   );
// }
